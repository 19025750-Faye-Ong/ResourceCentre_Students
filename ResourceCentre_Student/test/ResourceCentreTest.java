...
>>>>>>> branch 'master' of https://github.com/19025750-Faye-Ong/ResourceCentre_Students.git
	}
...
=======
		...
		//boundary
		assertNotNull("Test if there is valid Chormebook arraylist to add to", chromebookList);
		ResourceCentre.addCamcorder(camcorderList, cc1);
		//error
		Boolean isReturned = ResourceCentre.doReturnChromebook(chromebookList, "CB0011");
		...
		//error
		isReturned = ResourceCentre.doReturnChromebook(chromebookList, "CB0013");
		assertFalse("Test if non-existing chrromebook CB0013 is returned - false?", isReturned);
>>>>>>> branch 'master' of https://github.com/19025750-Faye-Ong/ResourceCentre_Students.git
	}
